...
// In-memory refresh token store — survives re-renders, cleared on page refresh (intentional)
...
api.interceptors.response.use(
  ...
  async error => {
    ...
    // Don't retry refresh or login endpoints, and don't retry already-retried requests
    if (
